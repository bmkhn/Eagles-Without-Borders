    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-card title="Deleted Members">
                {{-- Filters --}}
                <form method="GET" action="{{ route('admin.members.trashed') }}" class="mb-4" x-data="{ submitting: false }" @submit="submitting = true">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-4">
                        ...
                        <div class="flex gap-2">
                            <button
                                ...
                                class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-indigo-500 transition disabled:opacity-70 disabled:cursor-wait"
                            >
                                    ...
                                    <x-table-column class="text-right">
                                        <div class="inline-flex gap-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.members.restore', $member->id) }}">
                                                ...
                                                <button
                                                    ...
                                                    onclick="
                                                        ...
                                                        if (confirm('{{ __('Restore this member along with their certificates and payments?') }}')) {
                                            ...
                                            <x-confirm-delete-modal
                                                ...
                                                method="DELETE"
                                                title="{{ __('Permanently Delete Member') }}"
                                                message="{{ __('This will permanently delete this member along with all their certificates, payments, and uploaded files. This action CANNOT be undone.') }}"
                                                confirm-text="DELETE"
                                                button-text="{{ __('Delete Forever') }}"
