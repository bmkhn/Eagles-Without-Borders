        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6">
                <x-card title="Search & Manage" class="mb-6">
                    <div class="mb-4">
                        <form method="GET" action="{{ route('admin.clubs.index') }}" class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between" x-data="{ submitting: false }" @submit="submitting = true">
                            <div class="flex-1">
                                    ...
                                    <div class="inline-flex gap-2">
                                        ...
                                        @else
                                            <x-confirm-delete-modal
                                                title="{{ __('Delete Club') }}"
                                                message="{{ __('Are you sure you want to delete this club? The club president login account will also be removed. This action cannot be undone.') }}"
