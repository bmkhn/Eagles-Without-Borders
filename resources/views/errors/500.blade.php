        ...
        <div class="py-16">
            <div class="max-w-lg mx-auto sm:px-6 lg:px-8 text-center">
                <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-8 sm:p-12">
                    <div class="inline-flex items-center justify-center size-16 rounded-full bg-red-100 dark:bg-red-500/10 mb-6">
...
@else
    ...
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        <head>
            ...
            <title>{{ __('Server Error') }} - {{ config('app.name', 'Eagles Without Borders') }}</title>
            ...
            <section class="flex-1 flex items-center justify-center py-16">
                <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div class="error-card text-center">
                        <!-- Icon -->
                        <div class="inline-flex items-center justify-center size-20 rounded-full bg-red-500/10 border border-red-500/20 mb-6">
                            <svg class="size-10 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"/>
                            </svg>
                        </div>
