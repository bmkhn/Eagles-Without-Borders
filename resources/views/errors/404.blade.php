        ...
        <div class="py-16">
            <div class="max-w-lg mx-auto sm:px-6 lg:px-8 text-center">
                <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-8 sm:p-12">
                    <div class="inline-flex items-center justify-center size-16 rounded-full bg-amber-100 dark:bg-amber-500/10 mb-6">
                        <svg class="size-8 text-amber-600 dark:text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@else
    ...
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        <head>
            ...
            <title>{{ __('Page Not Found') }} - {{ config('app.name', 'Eagles Without Borders') }}</title>
