        ...
        <div class="py-16">
            <div class="max-w-lg mx-auto sm:px-6 lg:px-8 text-center">
                <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-8 sm:p-12">
                    <div class="inline-flex items-center justify-center size-16 rounded-full bg-yellow-100 dark:bg-yellow-500/10 mb-6">
                        <svg class="size-8 text-yellow-600 dark:text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-sm text-gray-400 dark:text-gray-500 mb-8">
                        {{ __('Your session has expired. Please go back, refresh the page, and try again.') }}
                    </p>
                    ...
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <a
                            ...
                            class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-semibold hover:bg-gray-50 dark:hover:bg-gray-600 transition"
                        >
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@else
    ...
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        <head>
            ...
            <title>{{ __('Session Expired') }} - {{ config('app.name', 'Eagles Without Borders') }}</title>
            ...
            <section class="flex-1 flex items-center justify-center py-16">
                <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div class="error-card text-center">
                        <!-- Icon -->
                        <div class="inline-flex items-center justify-center size-20 rounded-full bg-yellow-500/10 border border-yellow-500/20 mb-6">
                        ...
                        <h1 class="text-5xl sm:text-6xl font-black tracking-tight mb-4">
                            <span class="text-yellow-500">419</span>
                        </h1>
